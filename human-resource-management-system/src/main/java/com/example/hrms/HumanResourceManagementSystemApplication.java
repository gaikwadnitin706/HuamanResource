...
public class HumanResourceManagementSystemApplication {
	...
	public CommandLineRunner CommandLineRunner() {
		...
		return args -> {
			...
			Employee employee = Employee.builder().employeeId(UUID.randomUUID().toString()).employeeFirstnName("Nitin")
					.employeeLastName("Gaikwad").employeEmail("gaikwadnitin@gmail.com")
					.employeeContactNumber("9156046014").employeeDepartment("Development")
					.employeeDesignation("Associate Software Engineer").employeeJoiningDate(LocalDate.of(2023, 07, 31))
					.leaveRequests(List.of(leaveRequest01, leaveRequest02))
					.performanceReviews(List.of(performanceReview01, performanceReview02))
					.skills(List.of(
			...
			performanceReview01.setEmployee(employee);
			performanceReview02.setEmployee(employee);
